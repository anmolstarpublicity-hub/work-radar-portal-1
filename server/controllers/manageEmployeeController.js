...
class ManageEmployeeController {
  ...
  static addEmployee = async (req, res) => {
    const { 
      ...
      workLocation, shift, monitoringName 
    } = req.body;
    ...
    try {
      ...
      const newEmployee = new Employee({
        ...
        joiningDate, workLocation, shift, monitoringName,
      });
  ...
  static updateEmployee = async (req, res) => {
    ...
    const fieldsToUpdate = [
      ...
      'hasAttendancePower', 'manualAttendanceStatus', 'manualAttendanceDate', 'monitoringName'
    ];
    ...
    fieldsToUpdate.forEach(field => {
      if (Object.prototype.hasOwnProperty.call(req.body, field)) {
        ...
        if (requiredFields.includes(field)) {
          ...
          // Optional fields: include if not undefined/null (allow empty string to clear values)
      ...
      const employees = await Employee.aggregate([
        ...
        // Stage 5: Shape the final output
        {
          $project: {
            ...
            hasAttendancePower: 1, manualAttendanceStatus: 1, manualAttendanceDate: 1, monitoringName: 1,
